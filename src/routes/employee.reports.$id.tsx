  ...
  return (
    <div className="space-y-6">
      ...
      <Card><CardContent className="space-y-4 p-6 text-sm">
        <div><p className="text-xs uppercase text-muted-foreground">Project</p><p>{project?.name ?? "Project"}</p></div>
        <div><p className="text-xs uppercase text-muted-foreground">Description</p><p>{r.completed}</p></div>
